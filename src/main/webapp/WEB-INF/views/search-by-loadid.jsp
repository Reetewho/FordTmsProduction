...
<head>
	...
	<title>AP Transport Center | Search by Load ID </title>
	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content">  
			<div class="row" style="margin-bottom:20px"> 
				<form method="POST" action="<c:url value='/searchby-loadid' />" data-toggle="validator" role="form" >        
					<div class="col-md-3">
						<div class="form-group has-feedback">
							<input type="text" name="loadid" id="loadid" value="${loadid}" class="form-control" placeholder="LoadID" data-minlength="6" data-error="Minimum of 6 characters" required="required"/>  
						</div>
				     </div>        
